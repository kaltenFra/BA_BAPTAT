...
from interfaces.translation_interface import TEST_TRANSLATION


class TEST_eulerVSquaternion(TEST_TRANSLATION): 

    def __init__(self, num_features, num_observations, num_dimensions):
        experiment_name = "translation_parameter_settings"
