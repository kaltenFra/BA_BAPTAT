...
class TEST_sigVSrwVScwVSrcw(TEST_BINDING): 
    ...
    def __init__(self, num_features, num_observations, num_dimensions):
        experiment_name = "binding_sigmoid_rw_cw_rcw_gest"
    ...
    def perform_experiment(self, sample_nums, scalers): 
        ...
        # set manually
        modified = 'det'
        model_path = 'CoreLSTM/models/LSTM_70_gestalten.pt'
        tuning_length = 10
        num_tuning_cycles = 3
        at_loss_function = nn.SmoothL1Loss(reduction='mean', beta=0.3)
        # at_loss_function = euklLoss
        loss_parameters = [('beta', 0.3), ('reduction', 'mean')]
