...
class TEST_eulerVSquaternion(TEST_COMBINATIONS_GESTALTEN): 

    def __init__(self, num_features, num_observations, num_dimensions):
        experiment_name = "rotation_euler_vs_quaternion_gest"
    ...
    def perform_experiment(self, sample_nums, rotation_types): 
        ...
        for type in rotation_types:
            ...
            self.BAPTAT.set_weighted_gradient_biases(
                [None, grad_bias, None])  
            ...
            results = super().run(
                ...
                at_loss_function,
                loss_parameters,
                [None, at_learning_rate_rotation, None], 
                at_learning_rate_state, 
                [None, at_momentum_rotation, None], 
                [None, grad_calc, None]
            )
