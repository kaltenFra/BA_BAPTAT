...
class TEST_COMBI_ALL_PARAMS(TEST_COMBINATIONS): 
    ...
    def __init__(self, num_features, num_observations, num_dimensions):
        experiment_name = "combination_all_parameter_settings"
...
def main(): 
    ...
    # parameter_values = [
    #     nn.SmoothL1Loss(reduction='sum', beta=10),
    #     nn.SmoothL1Loss(reduction='sum', beta=20),
    #     nn.SmoothL1Loss(reduction='mean', beta=0.1),
    #     nn.MSELoss()]
    ...
    # tested_parameter = 'loss_parameters'
    # parameter_values = [
    #     [('beta', 1),('reduction', 'sum')], 
    #     [('beta', 10),('reduction', 'sum')]
    # ]
    ...
    # tested_parameter = 'grad_calculations' 
    # parameter_values = [
        # ['meanOfTunHor','meanOfTunHor','meanOfTunHor'],
        # ['weightedInTunHor','meanOfTunHor','meanOfTunHor'],
        # ['weightedInTunHor','meanOfTunHor','weightedInTunHor']
        # ['weightedInTunHor','weightedInTunHor','meanOfTunHor'],
        # ['weightedInTunHor','weightedInTunHor','weightedInTunHor']
    # ]

    # tested_parameter = 'at_learning_rate_state'
    # parameter_values = [0.0, 0.001, 0.01, 0.1, 0.2, 0.4, 0.6]
