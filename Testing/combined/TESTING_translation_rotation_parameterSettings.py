...
class TEST_COMBI_ALL_PARAMS(TEST_COMBINATIONS): 
    ...
    def __init__(self, num_features, num_observations, num_dimensions):
        experiment_name = "combination_t_r_parameter_settings"
    ...
    def perform_experiment(self, sample_nums, changed_parameter, parameter_values): 
        ...
        grad_calculations = [None, grad_calc_rotation, grad_calc_translation]
        
        grad_bias_rotation = 1.5 
        grad_bias_translation = 1.5 
        grad_biases = [None, grad_bias_rotation, grad_bias_translation]
        ...
        for val in parameter_values: 
            ...
            results = super().run(
                ...
                at_loss_function,
                loss_parameters,
                [None, at_learning_rate_rotation, at_learning_rate_translation], 
                at_learning_rate_state, 
                [None, at_momentum_rotation, at_momentum_translation],
                grad_calculations
            )
